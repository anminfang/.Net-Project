...
'File:                   ClsFillingStation_EventArgs_FuelTankRefilling.vb
'Author:                 Anmin Fang
...
Public Class FillingStation_EventArgs_FuelTankRefilled
    Inherits EventArgs
...
End Class 'FillingStation_EventArgs_FuelTankRefilled
